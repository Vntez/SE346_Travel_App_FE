                ...
                <View style={{ flexDirection: 'row', columnGap: 25, marginTop: 5 }}>
                    <TouchableHighlight underlayColor="transparent" onPress={handlePress}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', columnGap: 5 }}>
                            <Fontisto name="like" size={20} color={isLiked ? MAIN_COLOR : "#908a8a"} />
                            <Text style={{ color: MAIN_COLOR, fontSize: 16, fontWeight: '600' }}>{likesCount}</Text>
                        </View>
                    </TouchableHighlight>
    ...
    return (
        ...
        >
            <FlatList
                ...
                ListHeaderComponent={
                    <View>
                        <View style={{ alignItems: 'center' }}>
                            ...
                            >
                                <View style={[styles.overlayReview, { flex: 1, justifyContent: 'center', alignItems: 'center' }]}>
                                    ...
                                    <Text style={{ color: MAIN_COLOR, fontSize: 60, fontWeight: 'bold' }}>4.9</Text>
                        ...
                        {/* Nút Write Review đã được xóa ở đây */}
                    </View>
                }
                contentContainerStyle={{ paddingBottom: 20 }}
            />

            {/* PHẦN INPUT MỚI Ở DƯỚI CÙNG */}
            <View style={styles.bottomInputContainer}>
                ...
                />
                <TouchableOpacity 
                    style={[styles.sendButton, { backgroundColor: reviewText ? MAIN_COLOR : '#ddd' }]}
                    disabled={!reviewText}
                >
